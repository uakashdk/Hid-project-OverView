...
const FooterContact = () => {
  ...
  return (
    <section className="footer-contact-section" ref={containerRef}>
      <div className="contact-hero-wrapper container">
      ...
      <div className="contact-form-panel">
        ...
        {formSubmitted ? (
          ...
          <form className="contact-form" onSubmit={handleSubmit}>
            ...
            <div className="contact-mini-footer">
              ...
              <div className="contact-direct-info">
                <a href="tel:+77755138686" className="info-link">+7 (775) 513 9696</a>
                <a href="mailto:archz@mail.com" className="info-link">archz@mail.com</a>
              </div>
            </div>
          </form>
        )}
