      ...
      <div className="overlay-content container">
        <nav className="overlay-nav">
          <ul>
            ...
            <li><Link to="/about" onClick={handleClose}>Studio</Link></li>
            <li><Link to="/portfolio" onClick={handleClose}>Works</Link></li>
            <li><Link to="/journal" onClick={handleClose}>Journal</Link></li>
